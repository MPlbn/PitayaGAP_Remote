...
WF_FULL_SIZE = 64*157 #WAS 10k to test
...
GEN_MAX_NUM_STEPS = 10

F_GEN_DEFAULT_WAVEFORM: str = WF_SINE
F_GEN_DEFAULT_DACRATE: int = 10048 # Was 10k, now matched to multiplication of 64
F_GEN_DEFAULT_HPOINT: float = 1000
F_GEN_DEFAULT_LPOINT: float = -1000
F_GEN_DEFAULT_SPOINT: float = 0
F_GEN_DEFAULT_FREQ: int = 1

F_GEN_RANGE_UP_LIMIT: float = 1000
F_GEN_RANGE_DOWN_LIMIT: float = -1000
...
GUI_DEFAULT_INTERVAL: int = 5 #TODO CHECK
...
F_GUI_FILETYPE_COMBOBOX_VALUES = ["csv"]
...
MAX_WAIT = 0.003 # 0.001 for main PC, 0.003 for laptop - it's old
#DEFAULT_RESISTANCE = 0.0
DEFAULT_CALIBRATIO = 1.0
CSV_MAX_ROWSIZE = 1000000